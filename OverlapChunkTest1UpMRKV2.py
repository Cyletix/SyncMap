...
class OverlapChunkTest1UpMRKV2:
    def __init__(self, time_delay, m=2):
        self.chunk = 0
        self.output_size = 8
        self.counter = -1
        self.tstep = time_delay  # 这里的time_delay就是论文中的tstep
        self.time_counter = 0    # 用于追踪当前时间步
        self.output_class = 0
        self.m = m              # 马尔可夫链阶数
    ...
    def trueLabel(self):
        return np.array((0,0,0,1,1,2,2,2))
    ...
    def plotSuperposed(self, input_class, input_sequence=None, save=False):
        ...
        t = [i for i in range(len(input_sequence))]
